...
const SITES = [
  {
    ...
    ui: {
      ...
      heroBio:      'I am a passionate note-taker who loves to capture thoughts, ideas, and knowledge in a structured way. This is my personal space to share insights, reflections, and learnings on various topics.',
      postsHeading: 'Notes',
      footerText:   '© 2026 Shoei451',
      avatarUrl:    'https://picsum.photos/seed/profile42/200/200',
      links: [
        { label: 'GitHub', href: 'https://github.com/Shoei451', icon: 'github' },
      ],
    },
  },
  {
    ...
    ui: {
      ...
      heroTitle:    'Shoei451<br>Docs.',
      heroBio:      'Here are some notes and documentation related to my projects, experiments, and learnings. This is a space for sharing insights, guides, and technical details about my work.',
